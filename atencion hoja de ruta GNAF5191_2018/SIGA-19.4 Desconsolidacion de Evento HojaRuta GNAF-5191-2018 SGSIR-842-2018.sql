...
where pcc.procurcod_sigla = 'CE/LP-T16-093/2018' 
*/
...
BEGIN
	...
	WHERE edpi.evadocperins_estado = 2 AND edpi.procur_codigo = 799 AND edpi.asidoc_codigo = 1;
