...
where pcc.procurcod_sigla = 'CE/LP-T429-940/2018' 
*/
...
BEGIN
	...
	WHERE edpi.evadocperins_estado = 2 AND edpi.procur_codigo = 1651 AND edpi.asidoc_codigo = 2;
	GET DIAGNOSTICS _actualizados = ROW_COUNT;	
	-- si no es lo esperado , hacer un rollback
	IF _actualizados != 55	THEN   
