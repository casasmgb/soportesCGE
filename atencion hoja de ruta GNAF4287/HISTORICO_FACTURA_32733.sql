...
-- HITORICO seguimiento_capacitacion.facturas_persona_inscripcion
	...
	'factura  32733 - Borrar la asociacion de inscripcion' as comentario_accion_realizada;
...
-- HITORICO seguimiento_capacitacion.personas_inscripcion
	...
	now() as fecha_ejecucion, 
	'Gabriel Casas M.' as funcionario_sgsir_responsable, 
	'factura  32733 - borrar la inscripcion' as comentario_accion_realizada;
--==============================
-- HITORICO seguimiento_capacitacion.certificacion_persona
	...
	now() as fecha_ejecucion, 
	'Gabriel Casas M.' as funcionario_sgsir_responsable, 
	'factura  32733 - eliminando el registro de certificado generado de la inscripcion' as comentario_accion_realizada;
-- HITORICO seguimiento_capacitacion.evaluacion_docente_personas_inscritas
	...
	now() as fecha_ejecucion, 
	'Gabriel Casas M.' as funcionario_sgsir_responsable, 
	'factura  32733 - eliminando el registro de notas generado de la inscripcion' as comentario_accion_realizada;
...
-- HITORICO acceso_externo.cuenta_persona_inscripcion
	...
	now() as fecha_ejecucion, 
	'Gabriel Casas M.' as funcionario_sgsir_responsable, 
	'factura  32733 - borrar la cuenta para la inscripcion' as comentario_accion_realizada;
