...
begin
	...
	(traza, tabla, fecha_ejecucion, funcionario_sgsir_responsable, comentario_accion_realizada)
	 ...
	 (
	       ...
	       FROM (
		     ...
		     where evadocperins_codigo = 46954 
		     and procur_codigo = 1101 
		     and perpre_codigo = '20180626_BCQGDN'
		    ) AS t
	 ) as traza,
	...
	(traza, tabla, fecha_ejecucion, funcionario_sgsir_responsable, comentario_accion_realizada)
	 ...
	 now() as fecha_ejecucion, 
	 'Gabriel Casas' as funcionario_sgsir_responsable, 
	 'actualizar notas para certificado' as comentario_accion_realizada;	
