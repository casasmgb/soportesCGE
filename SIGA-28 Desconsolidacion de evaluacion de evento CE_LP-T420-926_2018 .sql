...
where pcc.procurcod_sigla = 'CE/LP-T420-926/2018' 
*/
...
BEGIN
	...
	WHERE edpi.evadocperins_estado = 2 AND edpi.procur_codigo = 1637 AND edpi.asidoc_codigo = 1;
	GET DIAGNOSTICS _actualizados = ROW_COUNT;	
	-- si no es lo esperado , hacer un rollback
	IF _actualizados != 13	THEN   
