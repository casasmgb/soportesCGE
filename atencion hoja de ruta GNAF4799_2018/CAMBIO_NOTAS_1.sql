...
WHERE pcc.procurcod_sigla='CE/CB-T11-564/2018' and pp.perpre_apellido_paterno = 'MAMANI' and pp.perpre_apellido_materno = 'CHAMBI'
--=================
select * from seguimiento_capacitacion.certificacion_persona where per_codigo =8902 and perpre_codigo = '20180807_MWOOOY' and codcer_numero = '23151'
--=================
*/
...
begin
	...
	(traza, tabla, fecha_ejecucion, funcionario_sgsir_responsable, comentario_accion_realizada)
	 ...
	 (
	       ...
	       FROM (
		     ...
		     where evadocperins_codigo = 45857 
		     and procur_codigo = 1217 
		     and perpre_codigo = '20180807_MWOOOY'
		    ) AS t
	 ) as traza,
	...
	evadocperins_calificaciones = '
		<table xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
			...
			<row>
			  ...
			  <doccrieva_descripcion>TRABAJO PRÁCTICO 1</doccrieva_descripcion>
			...
			<row>
			  ...
			  <doccrieva_descripcion>EVALUACIÓN 1</doccrieva_descripcion>
			...
			<row>
			  ...
			  <doccrieva_descripcion>EVALUACIÓN FINAL</doccrieva_descripcion>
	...
	where evadocperins_codigo = 45857 and procur_codigo = 1217 and perpre_codigo = '20180807_MWOOOY';
	...
	(traza, tabla, fecha_ejecucion, funcionario_sgsir_responsable, comentario_accion_realizada)
	 ...
	 (
	       ...
	       FROM (
		     ...
		     where per_codigo =8902 and perpre_codigo = '20180807_MWOOOY' and codcer_numero = '23151'
		    ) AS t
	 ) as traza,
	 'seguimiento_capacitacion.evaluacion_docente_personas_inscritas ' as tabla,
	 now() as fecha_ejecucion, 
